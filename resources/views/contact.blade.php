...
@section('content')
    ...
    <!-- Page title -->
    <section class="page-title-wrap position-relative bg-light"  data-bg-img="{{ asset($info->contact_header_image) }}"   data-animate="fadeInUp" data-delay="1.1">
            ...
            <div class="row align-items-lg-start">
                <div class="col-lg-6 col-md-6">
                    <div class="section-title">
                        ...
                        <p data-animate="fadeInUp" data-delay="1.5"><i class="fa fa-map-marker-alt"></i> <b>@lang('contact.my_location'):</b> <a
                                href="{{ $contactInfo->location_link }}" target="_blank">{{ $contactInfo->location }}</a>
                        </p>
                        </p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6" data-animate="fadeInUp" data-delay="1.6">
                    <div class="contact-form-wrap">
                        ...
                        <form id="contactFrom" method="post" action="{{ route('contact.post') }}" class="row">
                            ...
                            <div class="col-md-6" data-animate="fadeInUp" data-delay="1.8">
                            ...
                            <div class="col-md-12" style="" data-animate="fadeInUp" data-delay=".2">
                                <div class="form-group">
                            ...
                            <div class="col-md-12" data-animate="fadeInUp" data-delay=".9">
