                ...
                <div class="row align-items-center">
                        ...
                        <nav data-animate="fadeInUp" data-delay=".9">
                            ...
                            <div class="header-menu">
                                <ul>
                                    ...
                                    <li><a href="{{ route('location.service.index', $location) }}">@lang('site.services')</a></li>
                                    <li><a href="{{ route('location.service.show', ['location' => $location->slug, 'service' =>'netherland-trips']) }}">الرحلات</a></li>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 d-none d-sm-block">
                        ...
                        <ul class="client-area text-right list-inline m-0" data-animate="fadeInUp" data-delay="1.1">
                            ...
                            <li><a class="btn btn-secondary" href="{{ $location->location_social_media->where('name', 'whatsapp')->first()->link }}" >أحجز تذكرتك الآن</a></li>
                        </ul>
                    </div>
                </div>
            </div>
