...
@section('title', 'SMS Larid ERP')
@section('smsLaridActive', 'active')

@section('content')

<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <div class="card-header">SMS Larid ERP</div>
</div>
<div>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="card-block">
            <form action="{{ route('dashboard.sms.larid.store') }}" method="post">
                @csrf()
