...
@section('title', 'Update Work Way')
@section('servicesActive', 'active')

@section('content')

<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <div class="card-header">Update Work Way For {{ $workway->service->title }}</div>
</div>
<div>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="card-block">
            <form action="{{ route('dashboard.services.workways.update', $workway->id) }}" method="post">
                @csrf()
                @method('PUT')
