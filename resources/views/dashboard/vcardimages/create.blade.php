...
@section('title', 'Add New VCard Image')
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <div class="card-header">Add New VCard Image For {{$customer->first_name}} {{$customer->last_name}}</div>
</div>
<div>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="card-block">
            <form action="{{ route('dashboard.customers.vcardimages.store', $customer->id) }}" method="post" enctype="multipart/form-data">
                @csrf()
